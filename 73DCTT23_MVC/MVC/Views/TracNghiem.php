...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/73DCTT23_MVC/Public/Css/TracNghiem.css">
...
<body>
    <div class="backgr">
        <div class="nentong">
            <form style="max-width: 400px;" action="http://localhost/73DCTT23_MVC/LoginController/login" method="post" class="login">
